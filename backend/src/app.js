...
const examPdfRoutes = require('./routes/exam-pdfs.routes');
const examSourceRoutes = require('./routes/exam-sources.routes');
...
app.use('/api/admin/exam-pdfs', examPdfRoutes);
app.use('/api/exams', examSourceRoutes);
