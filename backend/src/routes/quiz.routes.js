...
router.get('/subject/:subjectId/manage/questions', auth, requireRoles(['ADMIN', 'TEACHER']), validate(quizParamsSchema, 'params'), listQuizQuestionsForManage);
router.post('/subject/:subjectId/questions', auth, requireRoles(['ADMIN', 'TEACHER']), validate(quizParamsSchema, 'params'), validate(createQuizQuestionSchema), createQuizQuestion);
router.patch('/questions/:questionId', auth, requireRoles(['ADMIN', 'TEACHER']), validate(quizQuestionParamsSchema, 'params'), validate(updateQuizQuestionSchema), updateQuizQuestion);
